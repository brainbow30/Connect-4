...
public class BoardTest {
    ...
    public void setupTest() {
        ...
        assertEquals(board.getCounter(positionBuilder.build()).get().getColour(), Counter.COLOUR.WHITE);
        positionBuilder.x(3).y(4);
        //noinspection OptionalGetWithoutIsPresent
        assertEquals(board.getCounter(positionBuilder.build()).get().getColour(), Counter.COLOUR.BLACK);
    ...
    public void addCounterTest() {
        ...
        board = new Board(8, new Verifier());
    ...
    public void flipLeftCounterTest() {
        ...
        assertEquals(counter1, board.getCounter(positionBuilder.build()).get());
        positionBuilder.x(4);
        assertEquals(Counter.COLOUR.WHITE, board.getCounter(positionBuilder.build()).get().getColour());
    }
    ...
    public void flipLeftDownCounterTest() {
        ...
        Counter counter2 = new Counter(Counter.COLOUR.BLACK);
        ...
        assertEquals(Counter.COLOUR.BLACK, board.getCounter(positionBuilder.build()).get().getColour());
    }
    ...
    public void flipRightDownCounterTest() {
        board = new Board(8, new Verifier());
        Counter counter1 = new Counter(Counter.COLOUR.BLACK);
        ImmutablePosition.Builder positionBuilder = ImmutablePosition.builder();
        positionBuilder.x(2).y(3);

        board.addCounter(counter1, positionBuilder.build());

        Counter counter2 = new Counter(Counter.COLOUR.WHITE);
